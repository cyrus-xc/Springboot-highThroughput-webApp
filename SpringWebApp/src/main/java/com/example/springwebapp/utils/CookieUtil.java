...
public final class CookieUtil {
    /**
     * Get Cookie value without decoding
     *
     * @param request
     * @param cookieName
     * @return
    ...
    /**
     * get Cookie value with decoding
     *
     * @param request
     * @param cookieName
     * @return
    ...
    /**
     * Set Cookie value, without setting max age, without encoding
     */
    ...
    /**
     * Set Cookie value, with max age, without encoding
     */
    public static void setCookie(HttpServletRequest request, HttpServletResponse
            response, String cookieName,
    ...
    /**
     * Set Cookie value, without max age, with encoding
     */
    public static void setCookie(HttpServletRequest request, HttpServletResponse
            response, String cookieName,
    ...
    /**
     * Set Cookie value, with max age, with encoding
     */
    public static void setCookie(HttpServletRequest request, HttpServletResponse
            response, String cookieName,
